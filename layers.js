...
lyr_GrmNovomestocenterbiotehnikeinturizma_1.set('fieldImages', {'id': 'TextEdit', 'SLO Ime': 'TextEdit', 'ENG Ime': 'TextEdit', 'Številka': 'TextEdit', 'Label': 'TextEdit', 'foto': 'TextEdit', 'povezava': '', });
lyr_GrmNovomestocenterbiotehnikeinturizma_1.set('fieldLabels', {'id': 'no label', 'SLO Ime': 'no label', 'ENG Ime': 'no label', 'Številka': 'no label', 'Label': 'hidden field', 'foto': 'no label', 'povezava': 'no label', });
